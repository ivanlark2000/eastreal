...
CREATE TABLE BF_Apatments_Ads (
    ...
    N_Year_Bealding smallint  NOT NULL,
    ...
    D_Date timestamp  NOT NULL,
    F_Procedure_Session int  NOT NULL,
    CONSTRAINT BF_Apatments_Ads_pk PRIMARY KEY (LINK)
);
...
-- Table: BF_Temp_Apatments_Ads
CREATE TABLE BF_Temp_Apatments_Ads (
    LINK int  NOT NULL,
    S_Area varchar(150)  NOT NULL,
    S_City varchar(150)  NULL,
    S_District varchar(150)  NOT NULL,
    ...
    S_Type_Of_Seller varchar(150)  NOT NULL,
    F_Sourse smallint  NOT NULL,
    CONSTRAINT BF_Temp_Apatments_Ads_pk PRIMARY KEY (LINK)
);
...
CREATE TABLE FS_Index_Polution (
    LINK smallint  NOT NULL,
    C_Name varchar(15)  NOT NULL,
    CONSTRAINT FS_Index_Polution_pk PRIMARY KEY (LINK)
);

COMMENT ON TABLE FS_Index_Polution IS 'Справочная таблица с индексами загрязнения воздуха
';

-- Table: FS_Kinde_Of_Repaire
CREATE TABLE FS_Kinde_Of_Repaire (
    LINK smallint  NOT NULL,
    C_Name varchar(100)  NULL,
    CONSTRAINT FS_Kinde_Of_Repaire_pk PRIMARY KEY (LINK)
);
...
-- Table: FS_Type_Of_Object
CREATE TABLE FS_Type_Of_Object (
    LINK smallint  NOT NULL,
    C_Name Varchar(100)  NULL,
    CONSTRAINT FS_Type_Of_Object_pk PRIMARY KEY (LINK)
);
...
-- Table: INF_Air_Polition
CREATE TABLE INF_Air_Polition (
    LINK int  NOT NULL,
    F_City smallint  NOT NULL,
    ...
    D_Date timestamp  NOT NULL,
    CONSTRAINT INF_Air_Polition_pk PRIMARY KEY (LINK)
);

COMMENT ON TABLE INF_Air_Polition IS 'Таблица с информации по общей оценке качества воздуха';
...
-- Table: MN_Apatments_Ads
CREATE TABLE MN_Apatments_Ads (
    LINK int  NOT NULL,
    ...
    F_Status_Of_Ads smallint  NOT NULL,
    D_Date timestamp  NOT NULL,
    CONSTRAINT MN_Apatments_Ads_pk PRIMARY KEY (LINK)
);
...
CREATE TABLE MN_House (
    ...
    F_Yard smallint  NULL,
    F_Type_House smallint  NOT NULL,
    S_Oficial_Bilder varchar(150)  NULL,
    S_Name_New_Bealding varchar(150)  NULL,
...
CREATE VIEW VW_Apatments_Ads AS
SELECT * FROM MN_Apatments_Ads;

COMMENT ON VIEW VW_Apatments_Ads IS 'Вьюха для вывода информацию по квартирам';
...
ALTER TABLE MN_Ads_Houses ADD CONSTRAINT BF_Ads_Houses_FS_Kinde_Of_Repaire
    ...
    REFERENCES FS_Kinde_Of_Repaire (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
-- Reference: BF_Apatments_Ads_FS_Floor (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Floor
    FOREIGN KEY (F_Floor)
...
-- Reference: BF_Apatments_Ads_FS_Kinde_Of_Repaire (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Kinde_Of_Repaire
    FOREIGN KEY (F_Kinde_Of_Repaire)
    REFERENCES FS_Kinde_Of_Repaire (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: BF_Apatments_Ads_FS_Method_Of_Sale (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Method_Of_Sale
...
-- Reference: BF_Apatments_Ads_FS_Qty_Room (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Qty_Room
    FOREIGN KEY (F_Qty_Room)
    REFERENCES FS_Qty_Room (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: BF_Apatments_Ads_FS_Sourse (table: BF_Apatments_Ads)
ALTER TABLE BF_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Sourse
    FOREIGN KEY (F_Sourse)
    REFERENCES FS_Sourse (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: BF_Apatments_Ads_FS_Type_Bathroom (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Type_Bathroom
...
-- Reference: BF_Apatments_Ads_FS_Type_House (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Type_House
...
-- Reference: BF_Apatments_Ads_FS_Type_Of_Room (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Type_Of_Room
...
-- Reference: BF_Apatments_Ads_FS_Type_Of_Seller (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Type_Of_Seller
    FOREIGN KEY (F_Type_Of_Seller)
    REFERENCES FS_Type_Of_Seller (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: BF_Apatments_Ads_FS_Type_Of_Transaction (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Type_Of_Transaction
...
-- Reference: BF_Apatments_Ads_FS_Window (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_FS_Window
...
-- Reference: BF_Apatments_Ads_LG_Procedure_Session (table: BF_Apatments_Ads)
ALTER TABLE BF_Apatments_Ads ADD CONSTRAINT BF_Apatments_Ads_LG_Procedure_Session
    FOREIGN KEY (F_Procedure_Session)
    REFERENCES LG_Procedure_Session (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: BF_Temp_Apatments_Ads_FS_Sourse (table: BF_Temp_Apatments_Ads)
ALTER TABLE BF_Temp_Apatments_Ads ADD CONSTRAINT BF_Temp_Apatments_Ads_FS_Sourse
    FOREIGN KEY (F_Sourse)
    REFERENCES FS_Sourse (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE INF_Descriptions ADD CONSTRAINT INF_Descriptions_MN_Apatments_Ads
    ...
    REFERENCES MN_Apatments_Ads (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
-- Reference: MN_Apatments_Ads_FS_Furniture (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT MN_Apatments_Ads_FS_Furniture
    FOREIGN KEY (F_Furniture)
    REFERENCES FS_Furniture (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: MN_Apatments_Ads_FS_Status_Of_Ads (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT MN_Apatments_Ads_FS_Status_Of_Ads
    FOREIGN KEY (F_Status_Of_Ads)
    REFERENCES FS_Status_Of_Ads (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: MN_Apatments_Ads_FS_Tehnics (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT MN_Apatments_Ads_FS_Tehnics
    FOREIGN KEY (F_Tehnics)
    REFERENCES FS_Tehnics (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: MN_Apatments_Ads_MN_House (table: MN_Apatments_Ads)
ALTER TABLE MN_Apatments_Ads ADD CONSTRAINT MN_Apatments_Ads_MN_House
    FOREIGN KEY (F_House)
...
ALTER TABLE INF_Air_Polition ADD CONSTRAINT WT_Air_Polition_FS_City
    FOREIGN KEY (F_City)
    REFERENCES FS_City (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: WT_Air_Polition_FS_Index_Polution (table: INF_Air_Polition)
ALTER TABLE INF_Air_Polition ADD CONSTRAINT WT_Air_Polition_FS_Index_Polution
    FOREIGN KEY (F_Index)
    REFERENCES FS_Index_Polution (LINK)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
