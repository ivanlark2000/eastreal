CREATE OR REPLACE FUNCTION pars_buildings() RETURNS trigger
AS
$$
BEGIN
...
CREATE TRIGGER unpack_biuldings
    BEFORE INSERT ON mn_json_building
    FOR EACH ROW
    EXECUTE PROCEDURE pars_buildings();
